...
const createIncidentUseCase = new CreateIncidentUseCase(incidentsRepositoryImp, usersRepositoryImp);
const createIncidentController = new CreateIncidentController(createIncidentUseCase);
